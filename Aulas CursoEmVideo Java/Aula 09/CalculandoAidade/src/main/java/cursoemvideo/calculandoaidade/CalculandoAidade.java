...
public class CalculandoAidade {
    public static void main(String[] args) {
        ...
        if (resposta == 1) {
            ...
            if (Idade >= 18) {
                System.out.println("Voce Trabalha?Você tem mais de 18 anos.");
                System.out.println("[1] Sim");
                System.out.println("[2] Nao");
                resposta = teclado.nextInt();
                if (resposta == 1) {
                    System.out.println("Você é Uma Pessoa Responsável!");
                } else {
                    System.out.println("Pensando Bem... Acho que você tá Na Iade de Procurar Trabalho.");
                }
            } else if (Idade < 18) {
                ...
                if (resposta == 1) {
                    ...
                    System.out.println("Acho que voce ta1 Na Iade de Saber oque voce quer ser quando Crescer.Oque você quer ser Quando for Adulto?");
                    String EmpregoA = teclado.next();
                    System.out.println("QUE LEGAL!Nao Sabia que voce queria ser Um/Uma " + EmpregoA);
                }
            } else if (Idade > 50) {
               System.out.println("O Senhor Ou Senhora Deve ter passado por Bastantes Aventuras!");
            }
        } else {
